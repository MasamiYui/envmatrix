...
extension L10n {
    static let enPackages: [String: String] = [
        ...
        "brew.uninstall.confirmTitle": "Uninstall %@?",
        "brew.uninstall.confirmMessage.formula": "This runs `brew uninstall %@`. Other formulae depending on it may stop working.",
        "brew.uninstall.confirmMessage.cask": "This runs `brew uninstall --cask %@` and removes the application bundle.",
        "brew.action.pin": "Pin",
    ...
    static let zhPackages: [String: String] = [
        ...
        "brew.uninstall.confirmTitle": "卸载 %@？",
        "brew.uninstall.confirmMessage.formula": "将执行 `brew uninstall %@`。依赖它的其他 formulae 可能无法继续工作。",
        "brew.uninstall.confirmMessage.cask": "将执行 `brew uninstall --cask %@`，并移除对应的应用程序。",
