...
public enum L10n {
    public static let strings: [String: [String: String]] = [
        "en": en
            ...
            .merging(enUv) { current, _ in current }
            ...
            .merging(enOnboarding) { current, _ in current },
        "zh": zh
            ...
            .merging(zhUv) { current, _ in current }
            .merging(zhPnpm) { current, _ in current }
            ...
            .merging(zhOnboarding) { current, _ in current }
    ]
}
