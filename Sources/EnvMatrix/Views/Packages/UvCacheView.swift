...
public struct UvCacheView: View {
    @StateObject private var vm = UvCacheViewModel()
    ...
    public var body: some View {
        ...
        .task { await vm.load() }
        .confirmationDialog(
            L("uvRepo.cache.confirmClean"),
            isPresented: $vm.showCleanConfirm,
            titleVisibility: .visible
        ) {
            Button(L("uvRepo.cache.clean"), role: .destructive) {
        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            HStack(spacing: 8) {
                ...
                Button(role: .destructive) {
                    ...
                    Label(L("uvRepo.cache.clean"), systemImage: "trash")
                }
