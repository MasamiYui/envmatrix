...
public struct PythonCacheView: View {
    @StateObject private var vm = PythonCacheViewModel()
    ...
    public var body: some View {
        ...
        .task { await vm.load() }
        .confirmationDialog(
            L("pythonRepo.cache.confirmClean"),
            isPresented: $vm.showCleanConfirm,
            titleVisibility: .visible
        ) {
            Button(L("pythonRepo.cache.clean"), role: .destructive) {
        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            HStack(spacing: 8) {
                ...
                Button(role: .destructive) {
                    ...
                    Label(L("pythonRepo.cache.clean"), systemImage: "trash")
                }
